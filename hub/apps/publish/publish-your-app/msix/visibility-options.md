...
The selections in the **Discoverability** section indicate how customers can discover and acquire your app. Note that Discoverability works together with Schedule. Your product is discovearble after its scheduled date. See [release dates in the Schedule section](./schedule-pricing-changes.md#configure-precise-release-scheduling) for more details
